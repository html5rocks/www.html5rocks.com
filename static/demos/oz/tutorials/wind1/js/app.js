...
(function() {
  ...
  App = (function() {
    ...
    function App() {
      ...
      this.grassTex = THREE.ImageUtils.loadTexture("textures/grass.png");
      this.initGrass();
      this.initTerrain();
    ...
    App.prototype.initGrass = function() {
      var NUM, i, j, mat, x, y, _i, _results;
      ...
      for (i = _i = 0; _i <= NUM; i = _i += 1) {
        _results.push((function() {
          ...
          for (j = _j = 0; _j <= NUM; j = _j += 1) {
            ...
            _results1.push(this.scene.add(this.instanceGrass(x, 2.5, y, 5.0, mat)));
          }
          return _results1;
        }).call(this));
      }
    ...
    App.prototype.instanceGrass = function(x, y, z, height, mat) {
      var geometry, mesh;
