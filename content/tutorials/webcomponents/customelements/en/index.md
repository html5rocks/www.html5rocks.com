...
<h3 id="extending">Extending elements</h3>
...
the name of the element. This this case, "button":
...
<h4 id="extendnative">Extending a custom element</h4>

To create an `<x-foo-extended>` element that extends the `<x-foo>` custom element, simply inherit it's prototype
